          ...
          <div>
            ...
            <div className="border border-gray-200 border-dashed rounded-md p-6 text-center text-gray-600">
              ...
              <input
                ...
                className="w-60 cursor-pointer text-[.5rem] bg-blue-200 rounded px-4 py-2 hover:bg-blue-300 delay-300 duration-400 hover:cursor-pointer mt-2"
              />
            </div>
          </div>
{/* settings */}
...
{/* pin */}
          <div className="text-right flex justify-end">
            <button
              ...
              className="bg-blue-200 text-white px-3 text-[.6rem] py-2 rounded-md flex items-center gap-1 hover:bg-blue-300 delay-300 duration-400 hover:cursor-pointer"
            >
              <FaMapPin /> Pin Memory
            </button>
          </div>
