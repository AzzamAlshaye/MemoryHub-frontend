...
// //     const categoryOk = categoryFilter === "All Categories" || r.reason === categoryFilter;
// //     return tabOk && statusOk && categoryOk;
// //   });
...
// //           <TabButton label="Post Reports" icon={FaThumbtack} active={activeTab==="post"} onClick={()=>setActiveTab("post")} />
// //           <TabButton label="Comment Reports" icon={FaCommentDots} active={activeTab==="comment"} onClick={()=>setActiveTab("comment")} />
// //         </div>
...
// //           <div className="flex gap-3">
// //             <Dropdown value={statusFilter} onChange={setStatusFilter} options={["All Reports", "Pending", "Resolved", "Dismissed"]}/>
// //             <Dropdown value={categoryFilter} onChange={setCategoryFilter} options={["All Categories", "Inappropriate content", "Spam", "Harassment", "Other"]} />
// //           </div>
// //           <div className="flex items-center gap-2">
// //             <span className="text-sm text-gray-500">Sort by:</span>
// //             <Dropdown value={sortFilter} onChange={setSortFilter} options={["Newest First", "Oldest First"]}/>
...
// //             return (
// //               <div key={r.id} className="border bg-white rounded-md shadow overflow-hidden">
...
// //                     </div>
// //                   </div>
// //                   <span className={`text-xs font-medium px-2 py-0.5 rounded ${getStatusColor(r.status)}`}>{r.status}</span>
// //                 </div>
...
// //                   <div className="bg-gray-50 border px-4 py-3 rounded text-sm">{r.reason}</div>

// //                   {r.resolutionReason && (
// //                     <div className="mt-3">
// //                       <p className="text-xs font-medium uppercase text-gray-400 mb-1">Resolution</p>
// //                       <div className="bg-gray-50 border px-4 py-3 rounded text-sm">{r.resolutionReason}</div>
// //                     </div>
// //                   )}

// //                   {(r.status==="pending"||r.status==="open") && (
// //                     <div className="mt-3">
// //                       <p className="text-xs uppercase font-medium text-gray-400 mb-1">Resolution Note</p>
// //                       <textarea
// //                         value={resolutionNotes[r.id] || ""}
...
// //                 key={n}
// //                 onClick={()=>setCurrentPage(n)}
// //                 className={`px-3 py-1 border rounded text-sm ${currentPage===n? "bg-blue-400 text-white" : "bg-white text-black"}`}
// //               >
// //                 {n}
// //               </button>
// //             )}
...
// // function ActionButton({ icon, label, onClick }) {
// //   const base = "flex items-center gap-2 text-sm px-3 py-1 border rounded";
// //   const colors = {
// //     Resolve: "text-green-600 hover:bg-green-100",
// //     Dismiss: "text-red-600 hover:bg-red-100",
// //     Details: "text-gray-600 hover:bg-gray-100"
// //   };
// //   return (
// //     <button onClick={onClick} className={`${base} ${colors[label] || ""}`}>
// //       {icon} {label}
// //     </button>
// //   );
// // }
...
// //         value={value}
// //         onChange={e => onChange(e.target.value)}
// //         className="appearance-none border rounded px-4 py-2 pr-8 text-sm"
// //       >
// //         {options.map(opt => <option key={opt} value={opt}>{opt}</option>)}
// //       </select>
// //       <FaChevronDown className="pointer-events-none absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-500" />
// //     </div>
// //   );
// // }
...
//     if (status === "resolved") return "bg-green-200 text-green-800";
//     if (status === "dismissed") return "bg-gray-200 text-gray-800";
//     return "bg-yellow-200 text-yellow-800"; // open
//   };
...
export default function AdminTicketsPage() {
  ...
  const getStatusColor = (status) => {
    ...
    return "bg-yellow-200 text-yellow-800"; // For "open" and others
  };
